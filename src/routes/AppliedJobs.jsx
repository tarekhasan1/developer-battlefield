    ...
    <div className="applied-job-sec">
      ...
      <div className="container mt-5 mb-3">
        <div className="text-end mb-2">
          <button onClick={seeRemoteJobs} className="rounded me-3 filter-btn">
            Show Remote Jobs
          </button>
          <button onClick={seeOnSiteJobs} className="rounded filter-btn">
            Show Onsite Jobs
          </button>
        </div>
        <div id="applied-job">
          {data &&
            ...
            data.map((jobData, index) => (
              <div key={index} className="job-card border rounded mb-4 p-4">
                ...
                <div className="d-flex align-items-center">
                  <div className="feature-job-card">
                    <h5 className="fw-semibold">{jobData.job_title}</h5>
                    <p className="text-muted fs-6">{jobData.company_name}</p>
